    ...
    return (
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end">
          ...
          <span className="text-[10px] text-zinc-500">Signed in</span>
        </div>
        <button
  ...
  return (
    <>
      ...
      {showAuthModal && (
        ...
        >
          <div 
            className="relative w-full max-w-md rounded-3xl border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] backdrop-blur-2xl animate-in fade-in zoom-in duration-200"
            onClick={(e) => e.stopPropagation()}
            style={{ maxHeight: '90vh', overflowY: 'auto' }}
          >
            {/* Enhanced Glassmorphism Background */}
            <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle_at_top_left,#ffffff20,transparent_50%),radial-gradient(circle_at_bottom_right,#4ade8030,transparent_50%)]" />
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-emerald-500/5 via-transparent to-sky-500/5" />
            ...
            <div className="relative">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-zinc-400">
                    {isSignUp
                      ? "Start analyzing videos and saving insights"
                ...
                <button
                  ...
                  className="rounded-lg border border-white/10 bg-white/5 p-2 text-zinc-400 transition hover:bg-white/10 hover:text-zinc-300"
                >
                  <svg
                    className="h-5 w-5"
                    fill="none"
              ...
              <form onSubmit={handleAuth} className="space-y-4">
                ...
                {authError && (
                  <div className="rounded-xl border border-red-400/30 bg-red-950/20 p-3 text-sm text-red-300">
                    {authError}
                  </div>
                )}
                ...
                <button
                  ...
                  className="group relative w-full overflow-hidden rounded-full bg-gradient-to-r from-zinc-50 to-zinc-100 px-6 py-3 text-sm font-bold tracking-wide text-zinc-950 shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_20px_40px_rgba(0,0,0,0.4)] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.2),0_25px_50px_rgba(0,0,0,0.5)] disabled:cursor-not-allowed disabled:opacity-50"
                >
